...
function gutenberg_examples_dynamic() {
	if (is_admin()) {
		wp_enqueue_script('dsgvoaio-block-script', plugins_url( '../../assets/js/blocks.js', __FILE__ ), array('wp-block-editor', 'wp-editor', 'wp-blocks', 'wp-components', 'wp-element', 'wp-i18n', 'wp-polyfill'), '1.0', false);
